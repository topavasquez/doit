...
export default function SignInScreen() {
  ...
  async function handleForgotPassword() {
    if (!email.trim()) {
      setErrorMsg("Ingresa tu correo primero");
      return;
    }
    clearError();
    setLoading(true);
        ...
        {step === "login" && (
          <View style={styles.card}>
            ...
            <TouchableOpacity
              style={[
                styles.primaryBtn,
                (loading || !email.trim() || !password) && styles.btnDisabled,
              ]}
              onPress={handleLogin}
        ...
        {(step === "verify-otp" || step === "verify-recovery") && (
          <View style={styles.card}>
            ...
            <TouchableOpacity
              style={[
                styles.primaryBtn,
                (loading || otpCode.trim().length < 6) && styles.btnDisabled,
              ]}
            ...
            <TouchableOpacity
              onPress={() => {
                clearError();
                setStep(step === "verify-otp" ? "register" : "forgot");
              }}
              style={styles.backBtn}
            >
              <Text style={styles.backText}>← Volver</Text>
